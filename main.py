...
window = tk.Tk()
window.title("Login To The Password Manager")
...
title_label = tk.Label(window, text="Welcome to Password Manager", font=("Helvetica", 24, "bold"), fg="#003366", bg="#f0f0f0")
...
password_label = tk.Label(input_frame, text="Master Password:", font=custom_font, fg="#333333", bg="#ffffff")
